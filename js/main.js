...
function informarCategoria(event) {
   ...
   let guardar= document.getElementById('insertar-Valor-Categoria');
   guardar.innerHTML="";

    array.forEach(plantilla=>{
       let lista=document.createElement('LI');
       lista.innerHTML=`Categoria: ${plantilla.categoria} -Producto: ${plantilla.nombre} -Cantidad:${plantilla.cantidad} -Precio:${plantilla.precio} `
       guardar.appendChild(lista);
...
function mandarDatos(arrayCont,cont,key) {
    ...
    document.getElementById('insertar-Valor-Categoria').value=`Categoria: ${plantilla.categoria} -Producto: ${plantilla.nombre} -Cantidad:${plantilla.cantidad} -Precio:${plantilla.precio} \n`
}
